 ...
 *
 */
public class TtCallback extends RrCallback {
    private static final int MAX_ROTATION = 15;

    public TtCallback(RecyclerView rv, RecyclerView.Adapter adapter, List datas) {
        this(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT, rv, adapter, datas);
//        super(rv, adapter, datas);
    }

    public TtCallback(int dragDirs, int swipeDirs, RecyclerView rv, RecyclerView.Adapter adapter, List datas) {
